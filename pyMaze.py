...
# Sky-themed colors
    dark = ('sky blue', 'white')            # Background (light blue sky)
    light = ('black', 'deep sky blue')      # Path and walls (soft and bright blues)
    black = ('midnight blue', 'black')      # Borders (dark blue for contrast)
    red = ('tomato', 'firebrick3')          # Markers (e.g., danger zones)
    cyan = ('cyan', 'light cyan')           # Water/streams
    green = ('sea green', 'pale green')     # Accents (vegetation)
    blue = ('dodger blue', 'black')    # Primary sky tones
    yellow = ('gold', 'light goldenrod')    # Sunlight accents
...
class maze:
    ...
    def CreateMaze(self, x=5, y=5, pattern=None, loopPercent=50, saveMaze=False, loadMaze=None, theme:COLOR=COLOR.dark):
        '''
